...
def _app(monkeypatch):
    ...
    # O mapa de bairros geocodifica via rede; nos testes isso é desativado para
    # manter a suíte offline e determinística.
    monkeypatch.setattr(location_logic, "geocode_neighborhood", lambda *a, **k: None)
...
def test_market_dashboard_renders_all_product_sections(monkeypatch):
    ...
    assert headings == [
        ...
        "Mapa dos bairros de Belo Horizonte",
        "Compare bairros",
        "Radar dos bairros",
